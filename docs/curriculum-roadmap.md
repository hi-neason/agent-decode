...
状态：v0.2，2026-09-17。面向程序员，中文优先。[第一章](chapters/01-llm-apis-and-streaming.mdx)已包含三类 API 与流式处理，其余章节为设计草案，随案例研究调整。
...
- **源码入口**：Pi 三个 Provider 对空 choices、内容块与终态的处理；官方接口／SDK 资料为字段语义依据。
